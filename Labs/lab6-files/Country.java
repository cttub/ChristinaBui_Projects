...
public class Country implements Comparable
{
    ...
    public boolean equals(Object obj) {
    	...
    	if(this.name==otherCountry.getName() && this.powerLevel==otherCountry.getPowerLevel() && this.nationalDish==otherCountry.getNationalDish())
            return true;
        else
            return false;
    ...
    public int compareTo(Object arg0) {
        ...
        else if(this.name.compareTo(otherCountry.getName())<0){
            //this.name is before
            return -1;
        }
        else if(this.name.compareTo(otherCountry.getName())>0){
